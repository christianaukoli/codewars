...
function howMuchWater(water, load, clothes){
    // write conditional for how much water is needed
    //console.log to see values
    console.log(water);
    console.log(load);
    console.log(clothes);
    //conditional for if it's too much clothes
    if (clothes > (2*load)){
      return "Too much clothes";
      //conditional for not enough clothes
    } else if (clothes < load){
      return "Not enough clothes";
        //conditional for enough clothes
    } else{
